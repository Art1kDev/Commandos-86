...
;
; Commands: help, dir, cls, info, echo, reboot, mem, col, mkdir, del, ren, copy, type, Hworld, edit, -doc, shutdown
...
;
; v1.02 | November 15, 2025 | Netherlands
bits 16
org 0x7E00
start:
	mov ax, 0x0003
...
do_matrix:
	...
	push si
	push di
	mov byte [matrix_old_attr], 0x07
	mov al, [current_attribute]
	mov [matrix_old_attr], al
	mov al, 0x02
	shl al, 4
	or al, 0x0A
	mov [current_attribute], al
...
welcome db 'COMMANDOS-86 v1.02',13,10,'Type "help" for commands.',13,10,0
prompt_str db 'C:>',0
...
help_msg db 'Available commands:',13,10,' help, dir, cls, info, echo, reboot, mem, col, mkdir',13,10,' del, ren, copy, type, Hworld, edit, -doc file.txt (view only), shutdown',13,10,0
info_msg db "____________________________________________________________",13,10
         db "| COMMANDOS-86 v1.02                                       |",13,10
         db "|__________________________________________________________|",13,10
         db "| Author/Developer: Art1kDev                               |",13,10
         db "|__________________________________________________________|",13,10
         db 0
dir_c db 'C:',13,10,0
...
matrix_exit_msg db 'Welcome back to reality...',0
